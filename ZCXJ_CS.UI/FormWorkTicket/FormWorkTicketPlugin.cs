...
namespace ZCXJ_CS.UI
{
    ...
    public class FormWorkTicketPlugin : IUIPlugin
    {
        ...
        public FormBase PluginForm
        {
            ...
            {
                if (_pluginForm == null)
                    _pluginForm = new FormWorkTicket();
                return _pluginForm;
            }
        }
        ...
        public Image PluginPic
        {
            ...
            {
                if (_pluginPic == null)
                    _pluginPic = Image.FromFile(PluginPath + "\\Res\\工单管理.png");
                return _pluginPic;
            }
        }
        public Image SelectPluginPic
        {
            get
            {
                if (_selectPluginPic == null)
                    _selectPluginPic = Image.FromFile(PluginPath + "\\Res\\S工单管理.png");
